...
enum NewsAPIFakes {
    ...
    "articles": [
    {
      ...
      "description": "The price of bitcoin has climbed to a new all-time high. But assigning the cryptocurrency a value is anything but trivial. The price of bitcoin has climbed to a new all-time high. But assigning the cryptocurrency a value is anything but trivial. The price of bitcoin has climbed to a new all-time high. But assigning the cryptocurrency a value is anything but trivial. The price of bitcoin has climbed to a new all-time high. But assigning the cryptocurrency a value is anything but trivial. The price of bitcoin has climbed to a new all-time high. But assigning the cryptocurrency a value is anything but trivial.",
    ...
    },
    {
      ...
      "description": "SEC chair warns bitcoin is stillSEC chair warns bitcoin is stillSEC chair warns bitcoin is stillSEC chair warns bitcoin is stillSEC chair warns bitcoin is still",
